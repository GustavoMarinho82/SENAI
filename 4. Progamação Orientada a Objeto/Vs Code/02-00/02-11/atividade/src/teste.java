                    ...
                    { System.out.print("\nDigite o código do brinquedo: ");
                      ...
                      if (i < cont_b)
                        ...
                        { entrada = new Scanner(System.in);
                          ...
                          System.out.print("Digite o estoque mínimo aceitvel: ");
                ...
                for (i=0;i<cont_b;i++)
                    { if (brinquedos[i].qtd_est < brinquedos[i].est_min)
                           { System.out.print("\n\nCodigo: " + brinquedos[i].cod);
                             ...
                             System.out.print("\nEstoque mínimo permitido: " + brinquedos[i].est_min +"\n");
                             achou = 1;
                            }
                    }
                if (achou == 0)
                   System.out.println("Nao existe produto com estoque abaixo do minimo\n");
        } // fim switch
 } while (op != 4);

} // fim main

//Criando a classe para registro
